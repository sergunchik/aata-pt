...
<xsl:variable name="es-ES">
    ...
    <localization string-id='continued'><xsl:text>Continúa en la próxima página</xsl:text></localization>
    <!-- Navigation Interface elements -->
    <!-- Assistive "skip to content" link -->
    <localization string-id='skip-to-content'><xsl:text>Directo al contenido principal</xsl:text></localization>
